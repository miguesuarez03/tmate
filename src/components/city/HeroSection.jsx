          ...
          <div className={styles.heroQuickLinks}>
            {whatsappGroup && (
              ...
              >
                ...
                <span>Grupo de WhatsApp de {city.name}</span>
              </a>
            )}
            <span className={styles.heroQuickLink} style={{ "--quick-color": "#0EA5E9", cursor: "default", opacity: 0.7 }}>
