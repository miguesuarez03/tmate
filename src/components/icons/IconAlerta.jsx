 ...
 */
export default function IconAlerta({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<path d="M64 40 L88 82 L40 82 Z" fill="#FFFFFF" opacity="0.95"/>
<rect x="61" y="56" width="6" height="16" rx="3" fill="#DC2626"/>
<circle cx="64" cy="76" r="3.2" fill="#DC2626"/>
</g>
