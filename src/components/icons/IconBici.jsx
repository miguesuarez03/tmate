...
/**
 * IconBici — icono ilustrado MAbroad (sistema 3D consistente).
 * Bicicleta — movilidad urbana / tips de ciudad.
 * Luz 135°, sombra navy 20%, brillo especular soft-light.
 * @param {number} size - tamaño en px (ancho y alto). Default 56.
 * @param {string} className
 */
export default function IconBici({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<circle cx="46" cy="78" r="12" fill="none" stroke="#FFFFFF" strokeWidth="5" opacity="0.95"/>
<circle cx="82" cy="78" r="12" fill="none" stroke="#FFFFFF" strokeWidth="5" opacity="0.95"/>
<path d="M46 78 L60 50 L74 50 M60 50 L82 78 M60 50 L52 62 L70 62" fill="none" stroke="#FFFFFF" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" opacity="0.95"/>
</g>
