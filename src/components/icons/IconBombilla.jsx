 ...
 */
export default function IconBombilla({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<circle cx="64" cy="56" r="16" fill="#FFFFFF" opacity="0.95"/>
<rect x="57" y="70" width="14" height="8" rx="2" fill="#FFFFFF" opacity="0.95"/>
<line x1="60" y1="82" x2="68" y2="82" stroke="#FFFFFF" strokeWidth="3" strokeLinecap="round" opacity="0.8"/>
</g>
