...
/**
 * IconCamara — icono ilustrado MAbroad (sistema 3D consistente).
 * Cámara — subir foto.
 * Luz 135°, sombra navy 20%, brillo especular soft-light.
 * @param {number} size - tamaño en px (ancho y alto). Default 56.
 * @param {string} className
 */
export default function IconCamara({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<rect x="40" y="52" width="48" height="34" rx="6" fill="#FFFFFF" opacity="0.95"/>
<rect x="54" y="44" width="20" height="10" rx="3" fill="#FFFFFF" opacity="0.95"/>
<circle cx="64" cy="69" r="10" fill="none" stroke="#0C2340" strokeWidth="4" opacity="0.55"/>
</g>
