...
/**
 * IconCiclo — icono ilustrado MAbroad (sistema 3D consistente).
 * Flechas cíclicas — cambios / actualización.
 * Luz 135°, sombra navy 20%, brillo especular soft-light.
 * @param {number} size - tamaño en px (ancho y alto). Default 56.
 * @param {string} className
 */
export default function IconCiclo({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<stop offset="0%" stopColor="#A6D5DB"/><stop offset="100%" stopColor="#10B981"/>
</linearGradient>
...
<path d="M48 56 A18 18 0 0 1 82 52" fill="none" stroke="#FFFFFF" strokeWidth="6" strokeLinecap="round" opacity="0.95"/>
<path d="M80 72 A18 18 0 0 1 46 76" fill="none" stroke="#FFFFFF" strokeWidth="6" strokeLinecap="round" opacity="0.95"/>
<path d="M82 44 L82 54 L72 52 Z" fill="#FFFFFF" opacity="0.95"/>
<path d="M46 84 L46 74 L56 76 Z" fill="#FFFFFF" opacity="0.95"/>
</g>
