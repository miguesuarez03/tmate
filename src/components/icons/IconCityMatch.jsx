...
/**
 * IconCityMatch — icono ilustrado TMate (sistema 3D consistente).
...
<stop offset="0%" stopColor="#0EA5E9"/><stop offset="55%" stopColor="#06B6D4"/><stop offset="100%" stopColor="#14B8A6"/>
</linearGradient>
