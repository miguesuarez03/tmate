 ...
 */
export default function IconClima({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<circle cx="52" cy="52" r="13" fill="#FBBF24"/>
<path d="M56 68 C46 68 40 74 44 82 L84 82 C90 82 90 70 80 68 C78 60 62 60 56 68 Z" fill="#FFFFFF" opacity="0.95"/>
</g>
