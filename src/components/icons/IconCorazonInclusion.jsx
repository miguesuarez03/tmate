...
/**
 * IconCorazonInclusion — icono ilustrado MAbroad (sistema 3D consistente).
 * Corazón — colectivo de menos oportunidades / inclusión.
 * Luz 135°, sombra navy 20%, brillo especular soft-light.
 * @param {number} size - tamaño en px (ancho y alto). Default 56.
 * @param {string} className
 */
export default function IconCorazonInclusion({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<stop offset="0%" stopColor="#10B981"/><stop offset="100%" stopColor="#3F7A7D"/>
</linearGradient>
...
<path d="M64 82 C40 66 40 48 54 46 C60 45 64 50 64 54 C64 50 68 45 74 46 C88 48 88 66 64 82 Z" fill="#FFFFFF" opacity="0.95"/>
</g>
