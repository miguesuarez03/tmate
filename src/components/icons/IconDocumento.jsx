...
/**
 * IconDocumento — icono ilustrado MAbroad (sistema 3D consistente).
 * Documento — informe / certificado único.
 * Luz 135°, sombra navy 20%, brillo especular soft-light.
 * @param {number} size - tamaño en px (ancho y alto). Default 56.
 * @param {string} className
 */
export default function IconDocumento({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<path d="M72 38 L72 48 L82 48 Z" fill="#0C2340" opacity="0.3"/>
<line x1="53" y1="62" x2="75" y2="62" stroke="#0EA5E9" strokeWidth="3" strokeLinecap="round"/>
<line x1="53" y1="72" x2="75" y2="72" stroke="#0EA5E9" strokeWidth="3" strokeLinecap="round"/>
</g>
