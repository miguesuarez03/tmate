...
/**
 * IconFiesta — icono ilustrado MAbroad (sistema 3D consistente).
 * Confeti — llegada / celebración.
 * Luz 135°, sombra navy 20%, brillo especular soft-light.
 * @param {number} size - tamaño en px (ancho y alto). Default 56.
 * @param {string} className
 */
export default function IconFiesta({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<circle cx="46" cy="50" r="4.5" fill="#FFFFFF" opacity="0.95"/>
<circle cx="82" cy="46" r="3.5" fill="#FFFFFF" opacity="0.85"/>
<circle cx="60" cy="42" r="3" fill="#FFFFFF" opacity="0.8"/>
<circle cx="80" cy="70" r="4" fill="#FFFFFF" opacity="0.85"/>
<path d="M44 84 L84 50" fill="none" stroke="#FFFFFF" strokeWidth="7" strokeLinecap="round" opacity="0.95"/>
</g>
