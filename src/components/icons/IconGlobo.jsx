 ...
 */
export default function IconGlobo({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<circle cx="64" cy="64" r="22" fill="none" stroke="#FFFFFF" strokeWidth="4.5" opacity="0.95"/>
<ellipse cx="64" cy="64" rx="9" ry="22" fill="none" stroke="#FFFFFF" strokeWidth="3.5" opacity="0.8"/>
<line x1="42" y1="64" x2="86" y2="64" stroke="#FFFFFF" strokeWidth="3.5" opacity="0.8"/>
</g>
