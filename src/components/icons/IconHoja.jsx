 ...
 */
export default function IconHoja({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<path d="M50 82 C46 60 58 42 82 40 C82 64 68 80 50 82 Z" fill="#FFFFFF" opacity="0.95"/>
<path d="M52 80 C60 66 68 56 80 44" fill="none" stroke="#10B981" strokeWidth="3" strokeLinecap="round" opacity="0.6"/>
</g>
