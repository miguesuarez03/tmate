...
/**
 * IconIdiomas — icono ilustrado TMate (sistema 3D consistente).
...
<text x="48" y="46" fontFamily="'DM Sans', sans-serif" fontSize="20" fontWeight="700" textAnchor="middle" fill="#FFFFFF">A</text>
<text x="80" y="80" fontFamily="'DM Sans', sans-serif" fontSize="20" fontWeight="700" textAnchor="middle" fill="#FFFFFF">B</text>
</g>
