...
/**
 * IconLupa — icono ilustrado MAbroad (sistema 3D consistente).
 * Lupa — búsqueda / preparación (paso 1 Proceso).
 * Luz 135°, sombra navy 20%, brillo especular soft-light.
 * @param {number} size - tamaño en px (ancho y alto). Default 56.
 * @param {string} className
 */
export default function IconLupa({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<circle cx="58" cy="58" r="16" fill="none" stroke="#FFFFFF" strokeWidth="7" strokeOpacity="0.95"/>
<line x1="70" y1="70" x2="84" y2="84" stroke="#FFFFFF" strokeWidth="8" strokeLinecap="round" strokeOpacity="0.95"/>
</g>
