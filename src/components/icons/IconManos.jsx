...
/**
 * IconManos — icono ilustrado MAbroad (sistema 3D consistente).
 * Manos — acuerdo / coordinación.
 * Luz 135°, sombra navy 20%, brillo especular soft-light.
 * @param {number} size - tamaño en px (ancho y alto). Default 56.
 * @param {string} className
 */
export default function IconManos({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<path d="M40 62 L58 62 L70 70 L62 78 L48 68 Z" fill="#FFFFFF" opacity="0.95"/>
<path d="M88 62 L70 62 L58 70 L66 78 L80 68 Z" fill="#FFFFFF" opacity="0.8"/>
</g>
