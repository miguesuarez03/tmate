...
/**
 * IconProceso — icono ilustrado MAbroad (sistema 3D consistente).
...
<text x="64" y="82" fontFamily="Georgia, 'Bricolage Grotesque', serif" fontSize="50" fontWeight="700" textAnchor="middle" fill="#FFFFFF" opacity="0.95">?</text>
</g>
