...
/**
 * IconReloj — icono ilustrado MAbroad (sistema 3D consistente).
 * Reloj — tiempo / plazo / espera.
 * Luz 135°, sombra navy 20%, brillo especular soft-light.
 * @param {number} size - tamaño en px (ancho y alto). Default 56.
 * @param {string} className
 */
export default function IconReloj({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<circle cx="64" cy="64" r="20" fill="none" stroke="#FFFFFF" strokeWidth="6" opacity="0.95"/>
<line x1="64" y1="64" x2="64" y2="50" stroke="#FFFFFF" strokeWidth="4.5" strokeLinecap="round"/>
<line x1="64" y1="64" x2="74" y2="70" stroke="#FFFFFF" strokeWidth="4.5" strokeLinecap="round"/>
</g>
