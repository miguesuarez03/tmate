 ...
 */
export default function IconSalud({ size = 56, className = "", ...rest }) {
  const uid = useId();
  return (
    <svg
      viewBox="0 0 128 128"
...
<rect x="56" y="42" width="16" height="44" rx="4" fill="#FFFFFF" opacity="0.95"/>
<rect x="42" y="56" width="44" height="16" rx="4" fill="#FFFFFF" opacity="0.95"/>
</g>
