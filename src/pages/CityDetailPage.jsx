...
export default function CityDetailPage() {
  ...
  useEffect(() => {
    ...
    if (meta) {
      meta.setAttribute("content",
        `Todo sobre el Erasmus en ${city.name}: coste ${city.costDetail}, scores reales, barrios y tips. Puntuación TMate: ${overallScore}/10.`
      );
    }
  }, [city, overallScore]);
  ...
  return (
    <div className="cdp-root">
      {/* NavbarCity espera cityName (string) y overall (number) */}
